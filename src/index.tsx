...
export default class Form extends Component {
 ...
 public validateElement(path, data, errors) {
 ...
 public handleEvent(eventName, path, originalHandler, event) {
 ...
 public cloneTree(element, parentPath = []) {
 ...
 public validateTree(errors = {}, element, parentPath = []) {
  if (!element || typeof element === 'string') {
   return errors
  }
 ...
 public render() {
  ...
  return (
   <form onSubmit={this.handleSubmit} className={className}>
    {React.Children.map(this.props.children, (child) => this.cloneTree(child))}
   </form>
  )
 }
}
